...
Native-Danish read before publication: 24 September 2026.
"""

HOW_IT_WORKS_DA = [
    ("h2", "Det, du giver os"),
    ("p", "En kopi. Ikke mere. Ingen migrering, intet nyt system, og ikke et års forberedelse "
          "først. En daglig kopi af de arkiver, du har i forvejen: datarummet, mailarkivet, "
          "bogføringseksporten, fællesdrevet og de scanninger, ingen har åbnet, siden de blev "
          "arkiveret."),
    ...
    ("p", "Resultatet er et arkiv, der er dit: kontrolleret, adresserbart og brugbart med enhver "
          "sprogmodel, vores eller den, du vælger om tre år. Det er helt bevidst. En kunde, der "
          "ikke kan gå, er ikke en kunde. Det er en fange."),
    ("h2", "Registeret: Det, der er, og det, der mangler"),
    ("p", "Mens dokumenterne bliver læst, bygges der et register op. Her står, hvilken kontrakt "
          "der rummer hvilken bestemmelse, hvilket referat der er underskrevet, hvilken faktura der "
          "hører til hvilken sag, og hvilket dokument der var ventet og aldrig kom. Registeret er "
          "noget, der er skrevet ned. Ikke noget, der er husket."),
    ...
    ("p", "Det, du får tilbage, er en sag, ikke et chatsvar: dokumenterne, deres rækkefølge, de "
          "afgørende ord, hullerne. Et menneske læser den og beslutter."),
    ...
    ("p", "Bag hende står en supervisor, der aldrig får et dokument eller et navn at se. Hun ser "
          ...
          "manglede, hvor læsningen ramte ved siden af. Fordi intet af dit materiale når hende, kan "
          "hun vælges efter, hvor godt hun tænker, og ikke efter, hvor hun befinder sig. I dag er "
          "det Claude fra Anthropic, efter vores mening den bedste model til den slags opgaver. Hun "
          "gør kollegaen lidt bedre hver nat, uden adgang til dine data."),
    ("h2", "Hvad det ikke er"),
    ("ul", [
        "<b>Ikke en chatbot på intranettet.</b> Kollegaen svarer ud fra et register, der blev "
        "bygget op, mens dine dokumenter blev læst, ikke ud fra det, en model kan huske om dem.",
        ...
        "<b>Ikke en, der skriver i dine systemer.</b> Der skrives kun tilbage, hvis du beder om det, "
    ...
    ("p", "Frida, dokumentkollegaen, er under forberedelse; det første kundeforløb er vi ved at "
          ...
          "leverandørs feed og holder shoppen opdateret efter det."),
]
...
QUESTIONS_DA = [
    ("Hvad får vi helt konkret fra Neural Logic?",
     ["En AI-kollega, der læser de arkiver, din virksomhed har i forvejen. Spørger du om en sag, "
      ...
      "med enhver sprogmodel, og et register over, hvad hvert dokument indeholder."]),
    ("Forlader vores data Europa?",
     ["Nej. Kollegaen, der læser dine dokumenter, kører på en europæisk model, Mistral, i Europa og "
      ...
      "Derfor kan hun vælges efter sine evner og ikke efter, hvor hun befinder sig: I dag er det "
      "Claude fra Anthropic, som kører uden for Europa. Hun ser kun, hvordan arbejdet gik: hvad der "
      "blev spurgt om, hvor mange dokumenter, hvilket ord der manglede. Dit materiale ser hun "
      "aldrig."]),
    ("Skal vi flytte vores dokumenter eller skifte system?",
     ["Nej. En daglig kopi af de arkiver, du har i forvejen, er nok: datarum, mailarkiv, "
      "bogføringseksport, fællesdrev. Intet skal flyttes, og dine folk arbejder videre præcis der, "
      "hvor de arbejder i dag."]),
    ("Hvilke arkiver og filer kan kollegaen læse?",
     ["Kontrakter, korrespondance, fakturaer, referater, rapporter og scanninger, fra flere arkiver "
      "på én gang. Scannet papir bliver læst som tekst. Dokumenter, man aldrig har kunnet søge i, "
      "bliver dermed en del af sagen som alle andre."]),
    ("Hvad sker der, hvis svaret slet ikke står i dokumenterne?",
     ["Så får du det at vide. “Ikke fundet” er et fuldgyldigt svar hos os, og det kommer fra "
      "registeret, der blev bygget op, mens alle dokumenterne blev læst, ikke fra en models "
      "hukommelse. Om en bestemmelse, en underskrift eller et referat mangler, er en kendsgerning "
      "om dit arkiv. Og sådan bliver det besvaret.",
      "I det meste af det arbejde, vores kunder lægger vægt på, er det lige så meget værd at vide, "
      "at noget mangler, som at finde det."]),
    ...
    ("Hvad er forskellen på det her og at spørge ChatGPT eller Copilot om vores filer?",
     ["En almindelig assistent svarer ud fra det, den har fundet, og det, den kan huske. Det, den "
      ...
      "En dokumentkollega læser hvert dokument, der hører med, fører et register over, hvad der "
      "står i dem, citerer kun det, hun har kontrolleret mod kilden, og nævner hullerne. Og hun "
      "holder grænsen: Dine dokumenter forbliver under en europæisk kontrakt."]),
    ("Hvem skriver vi kontrakt med, og hvem hæfter?",
     ["Axon Trade ApS, et dansk anpartsselskab med hjemsted i København, CVR 45 92 07 63. Neural "
      "Logic er et brand under det selskab, ikke en selvstændig juridisk enhed. Kontrakter, "
      "fakturaer og databehandleraftalen står alle i Axon Trade ApS' navn, og selskabet tegnes af "
      "direktøren."]),
    ("Hvordan ser et første forløb ud?",
     ["Lille og målbart. En kort første kontrakt på en rigtig sag hos jer, ikke en demonstration, "
      "og bedømt på det, den leverer. Derefter to korte faser mere. Efter hver fase kan du stoppe "
      "og beholde alt, der er lavet indtil da: det konverterede arkiv, registeret, glossaret.",
      "Meningen er, at du beslutter ud fra beviser i dine egne sager, ikke ud fra slides. Og den "
      "første fase kan betale sig, selv hvis du stopper der. Hvorfor det, står i det næste svar."]),
    ("Og hvis vi stopper efter første fase, hvad står vi så med?",
     ["Det, enhver virksomhed før eller siden får brug for alligevel: dine filer i et kontrolleret, "
      ...
      "de ord, I bruger i huset. Intet af det er lavet til vores software. Det virker med enhver "
      ...
      "PDF'er og mailtråde, kan ingen AI, der er værd at stole på, bruge til noget. Konverteringen "
      "er den langsomme del, ikke den kloge, der kommer bagefter. At få den gjort på en lille første "
      "kontrakt, på rigtige sager, med et resultat, der er dit, er den billige måde at få den "
      "overstået på.",
      "Derfor er første fase hos os et løfte, ikke en prøve. Uanset hvad du beslutter bagefter, er "
      "du længere fremme, end du var."]),
    ("Hvad koster det?",
     ["Prisen sættes pr. forløb, for arbejdet afhænger af, hvor meget du har, og hvilken stand det "
      "er i. Første fase holder vi bevidst lille, så den første beslutning også er lille. Skriv til "
      "os med en idé om, hvilke arkiver det drejer sig om, så får du et klart svar."]),
    ("Hvilke sprog arbejder kollegaen på?",
     ["Dansk, tysk og engelsk. Selskabet ligger i København, og stifteren er tysk, så der bliver "
      "skrevet direkte på alle tre sprog uden oversættelse undervejs."]),
    ("Hvem står bag Neural Logic?",
     ["Thomas Möller, stifter og eneejer af Axon Trade ApS i København. Selskabet driver også "
      "hockeybutikken Hockey24. Selskabsoplysningerne, inklusive CVR-udskriften, finder du på "
      "<a href=\"https://axontrade.dk/\">Axon Trades side</a>."]),
]

PROPERTY_DA = [
    ("h2", "Problemet i branchen"),
    ("p", "Til en ejendom hører årtiers papir: købet, lejekontrakterne med tillæg, "
          "afleveringsprotokollerne, mangellisterne, brevvekslingen med lejere og håndværkere, "
          "forsikringssagen, ingen fik lukket, og fakturaerne fra en reparation, som alle husker "
          "forskelligt. Det hele ligger i datarummet, i mailarkivet og på fællesdrevet. Og ingen har "
          "tid til at gennemgå alle tre."),
    ...
    ("ul", [
        ...
        "<b>Det, der mangler, nævnt ved navn.</b> Afleveringsprotokollen, der aldrig blev "
        "underskrevet. Tillægget, alle henviser til, og som ikke ligger nogen steder. Attesten, der "
        "er udløbet. Fra registeret, ikke fra et gæt.",
    ...
    ("h2", "Hvad hun ikke gør"),
    ("p", "Hun udtaler sig ikke om personer: ingen karakterer til lejere, ingen forudsigelser om, "
          "hvem der betaler. Kun sager om bygninger, kontrakter og forløb. Hun skriver ikke ind i "
          "dit administrationssystem, medmindre du beder om det, og reglerne tillader det. Og hun "
          "beslutter ingenting: Et menneske læser sagen og handler."),
    ("h2", "Sådan kunne det begynde hos jer"),
    ("p", "Med én rigtig ejendom eller én rigtig tvist fra jeres eget arkiv, under en "
          "databehandleraftale. Bedøm resultatet på en sag, hvor du allerede kender svaret. Ærligere "
          "kan man ikke afprøve sådan en kollega."),
...
LAW_DA = [
    ...
    ("p", "Sagen er arbejdet. En sag kommer med årevis af korrespondance, udkast, der ligner "
          "hinanden til forveksling, et aftalebrev et sted i mappen, fakturaer for de enkelte faser "
          "og en klient, der husker et tilsagn, som måske står på skrift, og måske ikke. At læse det "
          "hele kan kun faktureres i teorien. I praksis sker det sidst på dagen, og af den, der har "
          "mindst tid til overs."),
    ("h2", "Hvad kollegaen gør ved det"),
    ("ul", [
        ...
        "<b>Et spor, der holder.</b> Hvert udsagn har en henvisning til originalen, så ræsonnementet "
    ...
    ("p", "Med én afsluttet sag, du kender ud og ind, læst fra jeres eget arkiv. Så kan du holde "
          "resultatet op mod det, du ved i forvejen. En lille første kontrakt, og det konverterede "
          "arkiv beholder du, uanset hvad du beslutter bagefter. Det er den kontrollerede, "
          "maskinlæsbare form af dine egne sager, som enhver AI de kommende år får brug for "
          "alligevel, og som ingen i sidste ende slipper for at bygge."),
